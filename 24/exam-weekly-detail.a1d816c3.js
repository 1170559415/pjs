! function (e) {
    function t(t) {
        for (var r, i, c = t[0], s = t[1], u = t[2], f = 0, p = []; f < c.length; f++) i = c[f], Object.prototype.hasOwnProperty.call(o, i) && o[i] && p.push(o[i][0]), o[i] = 0;
    ...
    "9kRk": function (e, t, n) {
        ...
        function x() {
            ...
            if (e.length > 1) {
                var t = e[e.length - 2];
                t.href && (window.location.href = S(t.href))
            }
        }

        function O() {
            var e = o.a.get("__UID__");
            return e || (e = s()(), o.a.set("__UID__", e, {
                expires: 365,
                domain: d.a.domain
            })), e
        }
        ...
        function S() {
            ...
            return e.startsWith("http") ? e : _(e)
        }
        ...
        function C(e, t) {
            return !Object(m.isEmpty)(t) && (e.questionDisplay === v.c.FILL ? t.size === e.answers.length && t.every((function (e) {
        ...
        function q(e, t) {
            if (e.result = !0, t.length !== e.correct.length && (e.result = !1), e.questionDisplay === v.c.RATIO && e.correct[0].value !== t[0].label && (e.result = !1), e.questionDisplay === v.c.CHECKBOX) {
                var n, r = y(e.correct);
                try {
                    for (r.s(); !(n = r.n()).done;) {
                        var o, a = n.value,
                ...
                try {
                    for (l.s(); !(u = l.n()).done;) {
                        ...
                        try {
                            for (d.s(); !(f = d.n()).done;) {
                                var h = f.value;
                                p.answerId === h.answerId && p.value === h.value && (m = !0)
                            }
                        } catch (e) {
                            d.e(e)
                        } finally {
    ...
    "I/Ru": function (e, t, n) {
        ...
        for (var v = 11; v <= 14; v++) f.FpLog.push(h.bind(null, v));
        m()({
            use: [],
        ...
        var P = function (e) {
            ...
            function u() {
                return w(this, u), c.apply(this, arguments)
            }
            return t = u, (n = [{
        ...
        var N = new O.a,
            B = function (e) {
                ...
                function s() {
                    ...
                    return function (e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, s), R(A(e = i.call(this)), "beforeunloadHandler", (function (t) {
                        if (e.state.isInProgress && !Object(c.n)()) {
                            t.preventDefault();
                            return t.returnValue = "退出后答题历史将不会保存", "退出后答题历史将不会保存"
                        }
                    })), R(A(e), "setupBeforeunloadListener", (function () {
                        window.addEventListener("beforeunload", e.beforeunloadHandler)
                    })), R(A(e), "removeBeforeunloadListener", (function () {
                        window.removeEventListener("beforeunload", e.beforeunloadHandler)
                    })), R(A(e), "startGoNextTimer", (function () {
                        e.nextTimer && clearTimeout(e.nextTimer), e.nextTimer = setTimeout((function () {
                            e.onClickNext()
                        }), 1e3)
                    })), R(A(e), "cancelGoNextTimer", (function () {
                        e.nextTimer && clearTimeout(e.nextTimer)
                    })), R(A(e), "onClickNext", (function () {
                        e.cancelGoNextTimer();
                        var t = e.state,
                    ...
                    })), R(A(e), "onClickCommit", (function () {
                        var t = e.state,
                            n = t.curQuestionIndex,
                            r = t.questions,
                            o = t.answers,
                            a = r.get(n);
                        a.answered = !0, a.chose = o.get(n), e.setState({
                            questions: r.set(n, a)
                        }), e.judge(a, o.get(n))
                    })), R(A(e), "onClickPre", (function () {
                        var t = e.state.curQuestionIndex;
                        t > 0 && e.setState({
                            curQuestionIndex: t - 1
                        }), Object(c.r)(E.a)
                    })), R(A(e), "onClickSubmit", _(regeneratorRuntime.mark((function t() {
                        var n, r, o, a, i, c;
                        return regeneratorRuntime.wrap((function (t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    return n = e.state, r = n.answers, o = n.questions, a = n.quizInfo, e.loading = !0, t.prev = 4, i = o.map((function (e, t) {
                                        var n = r.get(t).map((function (e) {
                                            return {
                                                answerId: e.answerId,
                                ...
                                case 9:
                                    c = t.sent, e.setState({
                                        ...
                                        e.scoreTimer = setTimeout((function () {
                                            e.getScore(c.queryTipScoreId)
                                        }), 2e3)
                                    })), t.next = 16;
                                    break;
                                case 13:
                                    t.prev = 13, t.t0 = t.catch(4), e.loading = !1;
                                case 16:
                                    return t.prev = 16, e.tipsTimer && window.clearTimeout(e.tipsTimer), t.finish(16);
                                case 19:
                                    Object(k.c)({
                                        actionType: "exam-weekly-finish"
                                    });
                                case 20:
                                case "end":
                                    return t.stop()
                    ...
                    })))), R(A(e), "getScore", function () {
                        var t = _(regeneratorRuntime.mark((function t(n) {
                            var r;
                            return regeneratorRuntime.wrap((function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return t.next = 2, x.a(n);
                                    case 2:
                                        r = t.sent, e.setState({
                                            scoreData: r || {},
                                            loading: !1
                ...
                return t = s, (n = [{
                    key: "componentDidMount",
                    value: (a = _(regeneratorRuntime.mark((function e() {
                        var t, n, r, o, a = this;
                        return regeneratorRuntime.wrap((function (e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return t = Object(c.g)(), n = t.id, r = "", e.prev = 2, e.next = 5, x.j({
                                        type: E.b.WEEKLY,
                                        id: n
                                    });
                                case 5:
                                    ...
                                    break;
                                case 8:
                                    e.prev = 8, e.t0 = e.catch(2), e.t0 && Object(v.a)({
                                        centered: !0,
                                        okText: "确定",
                                        title: "网络开小差~请稍后重试",
                                        onOk: function () {
                                            a.removeBeforeunloadListener(), window.location.href = "/points/exam-weekly-list.html"
                                        }
                                    });
                                case 11:
                                    return e.prev = 11, this.tipsTimer && window.clearTimeout(this.tipsTimer), e.finish(11);
                                case 14:
                                    if (o) {
                                        e.next = 16;
                                        break
                                ...
                                case 16:
                                    N.start(), r = o && o.name, this.uniqueId = o.uniqueId, this.setState({
                                        questions: Object(m.a)(o.questions),
                                        title: r,
                                        quizInfo: o,
                                        isInProgress: !0
                    ...
                    value: function () {
                        var e = this,
                            ...
                            x = t.isInProgress,
                            O = t.loading,
                            k = r.get(a) || Object(m.a)(),
                            P = n.get(a);
                        return o.a.createElement(d.a, null, o.a.createElement(p.Helmet, null, o.a.createElement("title", null, s)), o.a.createElement("div", {
                            className: "exam-weekly-detail"
                        }, o.a.createElement(h.a, {
                            navs: [h.b.HOME, h.b.MY_STUDY, h.b.EXAM_INDEX, h.b.EXAM_WEEKLY_INDEX, h.b.EXAM_DOING],
                            onLeave: function (t, n) {
                                x && !Object(c.n)() && (t.preventDefault(), Object(y.a)({
                                    title: "确定要退出答题？退出后作答历史将不会保存",
                                    onOk: function () {},
                                    onCancel: function () {
                                        e.removeBeforeunloadListener(), window.location.href = n.href
                                    },
                                    okText: "继续",
                                    cancelText: "退出"
                                }))
                            }
                        }), o.a.createElement(j.a, null), o.a.createElement("div", {
                            className: "header-row"
                        }, o.a.createElement("div", {
                            className: "title"
                        }, i), !l && o.a.createElement("div", {
                            className: "pager"
                        }, o.a.createElement("span", {
                            className: "big"
                        }, a + 1), "/", n.size)), l && o.a.createElement(f.a, {
                            spinning: O
                        }, o.a.createElement(b.a, z({
                            type: E.b.WEEKLY
                        }, l, v))), !l && P && o.a.createElement("div", {
                            className: "detail-body"
                        }, o.a.createElement(g.a, {
                            readOnly: P.answered,
                            solutionMode: void 0 !== P.result,
                            question: P,
                            answers: k,
                            onChange: function (t) {
                                P.answered || e.setState({
                                    answers: r.set(a, t)
                                }, (function () {}))
                            }
                        }), o.a.createElement("div", {
                            className: "action-row"
                        }, 0 !== a && o.a.createElement("div", {
                            className: "pre-btn",
                            onClick: this.onClickPre
                        }, "< ", "上一题"), P.answered && a !== n.size - 1 && o.a.createElement(u.a, {
                            type: "primary",
                            className: "next-btn",
                            onClick: this.onClickNext
                        }, "下一题"), !P.answered && o.a.createElement(u.a, {
                            type: "primary",
                            className: "next-btn",
                            disabled: this.isCommitButtonDisabled(),
                            onClick: this.onClickCommit
                        }, "确定"), a === n.size - 1 && P.answered && o.a.createElement(u.a, {
                            type: "primary",
                            className: "next-btn",
                            onClick: this.onClickSubmit
                        }, "完成")), P.answered && !1 === P.result && o.a.createElement(w.a, {
                            question: P
                        }))))
                    }
                }, {
                    key: "judge",
                    value: function (e, t) {
                        var n = this.state.questions,
                            r = t.toJS();
                        Object(c.d)(e, r), e.result && this.startGoNextTimer();
                        var o = n.findIndex((function (t) {
                            return t.questionId === e.questionId
                        }));
                        o === n.size - 1 && e.result && this.onClickSubmit(), this.setState({
                            questions: n.set(o, e)
                        })
                    }
                }, {
                    key: "isCommitButtonDisabled",
                    value: function () {
                        var e = this.state,
                            t = e.curQuestionIndex,
                            n = e.questions,
                            r = e.answers,
                            o = n.get(t),
                            a = r.get(t);
                        return !Object(c.o)(o, a)
                    }
                }]) && I(t.prototype, n), r && I(t, r), s
            }(o.a.Component);
        Object(c.q)() || i.a.render(o.a.createElement(B, null), document.getElementById("app"))
    },
    "ON/i": function (e, t, n) {
        "use strict";
        var r = n("xwgP"),
    ...
    Srv0: function (e, t, n) {
        ...
        var o = function () {
            ...
            return t = e, (n = [{
                key: "start",
                value: function () {
                    this.started || (this.startTime = Date.now(), this.records = [], this.running = !0, this.started = !0)
                }
            }, {
                key: "pause",
                value: function () {
                    this.running && (this.records.push({
                ...
                key: "resume",
                value: function () {
                    this.running || (this.startTime = Date.now(), this.running = !0)
                }
            }, {
                key: "stop",
                value: function () {
                ...
                key: "getSecs",
                value: function () {
                    return Math.ceil(this.getMiliSecs() / 1e3)
                }
    ...
    XSgU: function (e, t, n) {
        ...
        var g = function (e) {
                ...
                function a() {
                    ...
                    return function (e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, a), b(v(e = o.call(this)), "show", (function (t) {
                        e.setState({
                            txt: t,
                            show: !0
                        })
                ...
                return t = a, (n = [{
                    ...
                    value: function () {
                        var e = this.state,
                            t = e.show,
                            n = e.txt;
                        return t && n ? s.a.createElement("div", {
                            id: "notification"
                        }, n) : null
                    }
            ...
            w = function () {
                ...
                var n = l.a.render(s.a.createElement(g, null), e);
                return function (e, r) {
            ...
            return t = c, (n = [{
                ...
                value: function () {
                    var e, t = this.props,
                        ...
                        h = t.onClickSolutionButton,
                        v = void 0 === h ? function () {} : h,
                        y = t.onClickReplayButton,
                        b = void 0 === y ? function () {
                        ...
                        P = d === j.b.WEEKLY,
                        z = !(E && a === f);
                    E ? e = "再来一次" : k ? e = "再来一组" : P && (e = "再练一次");
                    var S = "",
                        _ = "";
                    return O && u && "--" !== u && (_ = "您的得分计入总积分"), 103 === g ? (S = "领取奖励已达今日上限", Object(x.m)("exam-paper-detail") && w("专项答题积分已达今日上限", 2e3)) : 102 === g && (S = "已领取积分"), S = _ ? S ? s.a.createElement("div", {
                        style: {
                            textAlign: "center"
                        }
                    }, S, s.a.createElement("div", null, _)) : _ : S, s.a.createElement("div", {
                        className: "practice-result"
                    }, E ? s.a.createElement(s.a.Fragment, null, s.a.createElement("div", {
                        className: "header"
                    }, s.a.createElement("div", {
                        className: "title"
                    }, "本次作答分数"), s.a.createElement("div", {
                        className: "number"
                        ...
                        className: "info"
                    }, "积分：", s.a.createElement(i.a, {
                        title: S,
                        visible: !!S,
                        placement: "right"
                    }, "--" === u ? u : "+".concat(u || 0))))) : s.a.createElement(s.a.Fragment, null, s.a.createElement("div", {
                        className: "header"
                    }, s.a.createElement("div", {
                        className: "title"
                    }, "本次答对题目数"), s.a.createElement("div", {
                        className: "number"
                    }, n)), s.a.createElement("div", {
                        className: "infos"
                    }, s.a.createElement("div", {
                        className: "info"
                    }, "正确率：", p), s.a.createElement("div", {
                        className: "info"
                    }, "用时：", null == l ? void 0 : l.replace(/′+/g, ":")), s.a.createElement("div", {
                        className: "info"
                    }, "错题数：", r), s.a.createElement("div", {
                        className: "info"
                    }, "积分：", s.a.createElement(i.a, {
                        title: S,
                        visible: !!S,
                        placement: "right"
                    }, "--" === u ? u : "+".concat(u || 0))))), s.a.createElement("div", {
                        className: "action-row"
                    }, z && s.a.createElement(o.a, {
                        type: "primary",
                        ghost: E,
                        className: "action",
                        onClick: b
                    }, e), E && s.a.createElement(o.a, {
                        type: "primary",
                        className: "action",
                        onClick: v
                    }, "查看解析")))
                }
            }]) && k(t.prototype, n), r && k(t, r), c
        }(s.a.Component);
        I.propType = {}
    },
    ePow: function (e, t, n) {
        e.exports = n.p + "study-exam/asset/f8676d8b5de5abb79672357fb202d016.svg"
    },
    eULb: function (e, t, n) {
        "use strict";
        n.d(t, "a", (function () {
        ...
        var C = function (e) {
                ...
                return t = a, (n = [{
                    ...
                    value: function () {
                        ...
                        return s.a.createElement("svg", j({
                            style: i,
                            className: o,
                            "aria-hidden": "true"
                        }, a), s.a.createElement("use", {
        ...
        var G = function (e) {
            ...
            return t = c, (n = [{
                ...
                value: function () {
                    ...
                    t.correct.map((function (e) {
                        var qiangguodaan = e.value || e.label;
                        var daan = document.getElementsByClassName('title')[0];
                        var big = document.getElementsByClassName('big')[0];
                        if(daan.getAttribute('value') == null){
                            daan.setAttribute("value", "第"+big.innerHTML+"题" + "答案");
                            daan.innerHTML = daan.getAttribute('value');
                        }
                        if(daan.getAttribute('value').indexOf("第"+big.innerHTML+"题")<0){
                            daan.setAttribute("value","第"+big.innerHTML+"题" + "答案");
                            daan.innerHTML = daan.getAttribute('value');
                        }
                        if(daan.getAttribute('value').indexOf(qiangguodaan) < 0){
                            daan.setAttribute("value", daan.getAttribute('value') + " " + qiangguodaan);
                            daan.innerHTML = daan.getAttribute('value');
                        }
                    }));
                    !this.span && this.createSpan(), t.questionDisplay === v.c.FILL && this.inputArr.forEach((function (t) {
                        t && e.setWidth(t)
                    }))
                }
            }, {
                ...
                value: function () {
                    var e = this.props,
                        ...
                        y = n.questionDisplay === v.c.RATIO,
                        b = n.questionDisplay === v.c.RATIO || n.questionDisplay === v.c.CHECKBOX;
                    return s.a.createElement("div", {
                    ...
                    }), v.c.getName(n.questionDisplay), u && s.a.createElement("span", {
                        className: "score"
                    }, "（本道题", n.questionScore, "分）"), d && f && this.getSolutionText(n)), n.videoUrl && s.a.createElement(g, {
                        className: "video-player",
                        videoUrl: n.videoUrl,
                        videoThumbnailUrl: n.videoThumbnailUrl
                    }), s.a.createElement("div", {
                        className: "q-body"
                    }, this.getBody(n)), s.a.createElement("div", {
                        className: "q-footer"
                    }, n.questionDesc && !d && s.a.createElement(o.a, {
                        ...
                        return s.a.createElement("div", {
                            ...
                            key: e.answerId,
                            onClick: function () {
                                l || c(y ? Object(m.a)([e]) : n ? a.delete(t) : a.push(e))
                            }
                        }, e.label, ". ", e.content)
                    }))), n.recommender && s.a.createElement("div", {
                        className: "q-tag"
                    }, "推荐：".concat(n.recommender)), s.a.createElement("br", null), n.supplier && s.a.createElement("div", {
                        className: "q-tag"
                ...
                value: function (e) {
                    ...
                    return t.map((function (e) {
                        ...
                        var t, n;
                        return e.target && a ? (n = "correct", t = T.a) : !a && e.choice && (n = "false", t = q.a), s.a.createElement("div", {
                            className: p()("q-answer", n),
                            key: e.answerId
                        }, e.label, ". ", e.content, t && s.a.createElement("img", {
                            className: "icon",
                            src: t
                        }))
                    }))
                ...
                value: function (e) {
                    var t = this,
                        ...
                        m = 0,
                        d = u.replace(/\(\)/g, "（）");
                    return d = d.replace(/（）/g, "()（）()"), s.a.createElement("div", null, e.questionDisplay !== v.c.FILL ? u : d.split("()").map((function (r, c) {
                        if ("（）" !== r) return s.a.createElement("span", {
                            key: c
                        }, r);
                        var u = e.answers[m].answerId;
                        m++;
                        var l, f = n ? e.chose || [] : t.props.answers,
                            ...
                            h = "";
                        n && e.chose && (h = d.value === (null === (l = e.correct.find((function (e) {
                            return e.answerId === d.answerId
                        }))) || void 0 === l ? void 0 : l.value) ? "correct" : "wrong");
                        var v = d ? d.value : "",
                            b = {};
                        return n && (b = t.getSolutionStyle(v)), s.a.createElement("input", {
                            ref: t.setRef(c),
                            className: p()("blank", h),
                            autoFocus: 1 === m,
                            type: "text",
                            ...
                            onChange: function (n) {
                                ...
                                e.correct ? (null === (r = e.correct.find((function (e) {
                                    return e.answerId === u
                                }))) || void 0 === r ? void 0 : r.value) !== a && (a = Object(y.e)(a)) : a = Object(y.e)(a);
                    ...
                    }, " ", "来源：".concat(l), " "), f && s.a.createElement("span", {
                        style: {
                            color: "#313ec3"
                        }
                    }, "（", f, "）")) : null)
                ...
                value: function (e) {
                    ...
                    return e.chose && 0 !== e.chose.length ? Object(y.l)(e) ? s.a.createElement(t, {
                        className: "correct"
                    }, "回答正确") : s.a.createElement(t, {
                        className: "wrong"
                    }, "回答错误") : s.a.createElement(t, {
                        className: "chosen"
                    }, "未作答")
                }
            }, {
    ...
    lw7w: function (e, t, n) {
        ...
        s.a.defaults.headers.common.Pragma = "no-cache";
        var h = s.a.create({
            withCredentials: !0
        });
        h.interceptors.request.use((function (e) {
            return new Promise((function (t) {
                u.clientID.ready((function () {
                    u.clientID.setCookie(l.a.domain), u.clientID.renew(), t(e)
                }), (function (n) {
                    p.a.error(n, {
        ...
        h.interceptors.response.use((function (e) {
            return e.data && 200 !== e.data.code ? (401 == e.data.code && (v || y()), Promise.reject(e)) : e
        }), (function (e) {
            return e.response ? 401 === e.response.status ? v || y() : o.a.error("".concat(e.response.data.error.message || e.response.data.message)) : o.a.error("系统繁忙，请稍后再试"), Promise.reject(e)
        }));
        ...
        function w() {
            return (w = d(regeneratorRuntime.mark((function e() {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/open/api/user/info", e.next = 3, h.get(b + "/open/api/user/info");
                        case 3:
        ...
        function x() {
            return (x = d(regeneratorRuntime.mark((function e() {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/open/api/auth/check", e.next = 3, h.get(b + "/open/api/auth/check");
                        case 3:
                            return t = e.sent, e.abrupt("return", t.data.data);
                        case 5:
                        case "end":
        ...
        s.a.create({}).interceptors.response.use((function (e) {
    ...
    mjDs: function (e, t, n) {
        ...
        var d = function (e) {
            ...
            function c() {
                return s(this, c), a.apply(this, arguments)
            }
            return t = c, (n = [{
                key: "render",
                value: function () {
    ...
    rd3M: function (e, t, n) {
        e.exports = n.p + "study-exam/asset/a8998784db44df5405dae4874ad5513f.svg"
    },
    tDyU: function (e, t, n) {
        "use strict";
        n.d(t, "f", (function () {
            ...
            l = function (e) {
                return new Promise((function (t) {
                    c.clientID.ready((function () {
                        c.clientID.setCookie(s.a.domain), c.clientID.renew(), t(e)
                    }), (function (n) {
                        u.a.error(n, {
                            filename: "cookie-fp-error"
                        }), t(e)
        ...
        Object(h.b)() && (o.a.defaults.headers.common.Pragma = "no-cache"), S.interceptors.request.use((function (e) {
            return z.setRequestHeaders(e.headers), l(e)
        }), f), S.interceptors.response.use((function (e) {
            var t = e.headers && e.headers["page-version-control"];
            return z.checkIsGray(t),
                function (e) {
                    if (e.data && 200 !== e.data.code) {
                        var t = (e.data || {}).code;
                        if (y) return Promise.reject();
                        if (401 === t) return y || (Object(v.a)({
                            title: "登录信息已过期，请重新登录",
                            onOk: function () {
                                Object(h.c)(), Object(h.i)(), y = !1
                            },
                            afterClose: function () {
                                y = !1
                            }
                        }), y = !0), Promise.reject();
                        if (403 === t) return Object(v.a)({
                            title: "校验失败，请稍后再试",
                            onOk: function () {
                                y = !1
                            },
                        ...
                        if (406 === t) return Object(v.a)({
                            title: "还没全量开放，请耐心等待哦～",
                            onOk: function () {
                                y = !1, Object(h.c)(), location.href = "https://www.xuexi.cn/notFound.html"
                            },
                            afterClose: function () {
                                y = !1
                            },
                        ...
                        if (100047 === t) return Object(h.c)(), window.location.href = "/points/exam-error.html", !1;
                        if (100002 === t) return Object(v.a)({
                            title: "试题已过期",
                            onOk: function () {
                                Object(h.c)(), location.href = "./exam-index.html", y = !1
                            },
                            afterClose: function () {
                                y = !1
                            },
                        ...
                        if (100046 === t) return Object(v.a)({
                            title: "您已经开启新的答题流程，本次答题流程已失效",
                            onOk: function () {
                                y = !1, Object(h.c)(), Object(h.j)()
                            },
                            afterClose: function () {
                                y = !1
                            },
                        ...
                        if (100050 === t && Object(v.a)({
                                centered: !0,
                                okText: "确定",
                                title: "网络开小差~请稍后重试"
                            }), 100051 === t) return Object(h.c)(), location.href = "https://www.xuexi.cn/notFound.html", Promise.reject();
                        if (140006 === t) return Object(v.a)({
        ...
        function M() {
            return (M = k(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/practice/pc/weekly/more", e.next = 3, S.get(_ + "/api/exam/service/practice/pc/weekly/more", {
                                params: t
                            });
                        case 3:
        ...
        function A() {
            return (A = k(regeneratorRuntime.mark((function e() {
                var t;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/practice/statistic", e.next = 3, S.get(_ + "/api/exam/service/practice/statistic");
                        case 3:
                            return t = e.sent, e.abrupt("return", t.data.data);
                        case 5:
                        case "end":
        ...
        function R() {
            return (R = k(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/answer/record/pc/list", e.next = 3, S.get(_ + "/api/exam/service/answer/record/pc/list", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function B() {
            return (B = k(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/solution", e.next = 3, S.get(_ + "/api/exam/service/detail/solution", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function D() {
            return (D = k(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/queryV3", e.next = 3, S.get(_ + "/api/exam/service/detail/queryV3", {
                                params: x(x({}, t), {}, {
                                    forced: !0
                                }),
                                examNet: !0
        ...
        function V() {
            return (V = k(regeneratorRuntime.mark((function e(t, n) {
                var r, o, a;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            ...
                            return e.next = 5, I(n, "专项答题");
                        case 5:
                            o = e.sent;
                        case 6:
                            return e.next = 8, S.post(_ + r, t, {
                                examNet: !0,
                                headers: o
                            });
                        case 8:
        ...
        function F() {
            return (F = k(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/save", e.next = 3, S.post(_ + "/api/exam/service/detail/save", t);
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
                        case 5:
                        case "end":
        ...
        function X() {
            return (X = k(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/paper/pc/list", e.next = 3, S.get(_ + "/api/exam/service/paper/pc/list", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function J() {
            return (J = k(regeneratorRuntime.mark((function e() {
                var t;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/common/deduplicateRandomSearchV3", e.next = 3, S.get(_ + "/api/exam/service/common/deduplicateRandomSearchV3", {
                                params: {
                                    limit: 5,
        ...
        function Z() {
            return (Z = k(regeneratorRuntime.mark((function e(t, n) {
                var r, o, a;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            ...
                            return e.next = 6, I(n, "每日答题");
                        case 6:
                            o = e.sent;
                        case 7:
                            return e.next = 9, S.post(_ + r, t, {
                                examNet: !0,
                                headers: o
                            });
                        case 9:
        ...
        function W() {
            return (W = k(regeneratorRuntime.mark((function e(t, n) {
                var r, o, a;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function ee() {
            return (ee = k(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/score", e.next = 3, S.get(_ + "/api/exam/service/detail/score", {
                                params: {
                                    queryTipScoreId: t
                                }
                            });
    ...
    tlJg: function (e, t, n) {
        ...
        function v() {
            var e = Object(u.trimEnd)(window.location.pathname, "/").split("/").pop();
            for (var t in p) {
                var n = p[t];
