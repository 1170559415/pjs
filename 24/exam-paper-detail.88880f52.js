! function (e) {
    ...
    "9kRk": function (e, t, n) {
        ...
        function O() {
            ...
            if (e.length > 1) {
                var t = e[e.length - 2];
                t.href && (window.location.href = z(t.href))
            }
        }
    ...
    MBZT: function (e, t, n) {
        ...
        var A = function (e) {
            ...
            function i() {
                return z(this, i), a.apply(this, arguments)
            }
            return t = i, (n = [{
                key: "render",
                value: function () {
                    ...
                    if (!t || Object(v.isEmpty)(t)) return null;
                    var c = Array.isArray(t) ? t.length : t.size;
                    return o.a.createElement("div", {
                        className: S()(n, "question-grid"),
                        style: {
        ...
        var ne = function (e) {
            ...
            function s() {
                ...
                return function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, s), Z(X(e = i.call(this)), "fetchSolution", function () {
                        ...
                        return regeneratorRuntime.wrap((function (t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    o = t.sent, e.setState({
                                        practiceResult: o,
                                        questions: Object(h.a)(o.questions),
                                        quizInfo: o,
                                        title: o.name,
                                        status: W
                                    });
                ...
                }()), Z(X(e), "beforeunloadHandler", (function (t) {
                    if (e.save(), e.state.status === Y && !Object(c.n)()) {
                        t.preventDefault();
                        return t.returnValue = "确定要退出考试?", "确定要退出考试?"
                    }
                })), Z(X(e), "setupBeforeunloadListener", (function () {
                    window.addEventListener("beforeunload", e.beforeunloadHandler)
                })), Z(X(e), "removeBeforeunloadListener", (function () {
                    window.removeEventListener("beforeunload", e.beforeunloadHandler)
                })), Z(X(e), "startTimer", (function () {
                ...
                })), Z(X(e), "stopTimer", (function () {
                    clearInterval(e.timer)
                })), Z(X(e), "markTimeout", (function (e) {
                    localStorage.setItem($(e), "1")
                })), Z(X(e), "checkTimeout", (function (e) {
                    var t = $(e),
                        n = !!localStorage.getItem(t);
                    return localStorage.removeItem(t), n
                })), Z(X(e), "timeout", (function () {
                    var t;
                ...
                })), Z(X(e), "flushDebouncedSave", (function () {
                    var t;
                    null === (t = e.debouncedSave) || void 0 === t || t.flush()
                })), Z(X(e), "onClickNext", (function () {
                    var t = e.state,
                        n = t.curQuestionIndex;
                    n < t.questions.size - 1 && e.setState({
                        curQuestionIndex: n + 1
                    }, e.flushDebouncedSave), Object(c.r)(M.a)
                })), Z(X(e), "onClickPre", (function () {
                    var t = e.state.curQuestionIndex;
                    t > 0 && e.setState({
                        curQuestionIndex: t - 1
                    }, e.flushDebouncedSave), Object(c.r)(M.a)
                })), Z(X(e), "onClickSolutionButton", (function () {
                    e.setState({
                        questions: Object(h.a)(e.state.practiceResult.questions),
                        status: W,
                        curQuestionIndex: 0
                    })
                })), Z(X(e), "gotoUnansweredQuestion", (function () {
                    var t = e.state,
                        n = t.answers,
                ...
                })), Z(X(e), "onClickSubmit", H(regeneratorRuntime.mark((function t() {
                    var n, r, o, a, i;
                    return regeneratorRuntime.wrap((function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                            ...
                            case 6:
                                return e.loading = !0, t.prev = 7, e.debouncedSave.cancel(), a = e.getQuestionsForSubmit(), e.stopTimer(), t.next = 13, C.k({
                                    id: r.id,
                                    type: r.type,
                                    questions: a,
                                    usedTime: o,
                ...
                })))), Z(X(e), "getQuestionsForSubmit", (function () {
                    var t = e.state,
                        n = t.answers;
                ...
                })), Z(X(e), "save", H(regeneratorRuntime.mark((function t() {
                    var n, r, o;
                    return regeneratorRuntime.wrap((function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                if (n = e.state, r = n.quizInfo, o = n.usedTime, n.status === Y) {
                                    t.next = 3;
                                    break
                                }
                                return t.abrupt("return");
                ...
                })))), Z(X(e), "getScore", function () {
                    var t = H(regeneratorRuntime.mark((function t(n) {
                        var r;
                        return regeneratorRuntime.wrap((function (t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return t.next = 2, C.a(n);
                                case 2:
                                    r = t.sent, e.setState({
                                        scoreData: r || {},
                                        loading: !1
            ...
            return t = s, (n = [{
                ...
                value: (a = H(regeneratorRuntime.mark((function e() {
                    var t, n, r, o, a, i, s, u, l, f, p = this;
                    return regeneratorRuntime.wrap((function (e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (t = Object(c.g)(), n = t.id, r = t.examScoreId, this.setupBeforeunloadListener(), (a = r ? W : Y) !== W) {
                                    e.next = 7;
                                    break
                                }
                            ...
                            case 7:
                                return i = {
                                    type: M.b.PAPER,
                                    id: n
                                }, this.checkTimeout(n) && (i.reset = !0), e.prev = 9, e.next = 12, C.j(i);
                            case 12:
                                s = e.sent, e.next = 18;
                                break;
                            case 15:
                            ...
                            case 24:
                                o = s.name, this.uniqueId = s.uniqueId, u = ee(s.questions), l = {
                                    questions: Object(h.a)(s.questions),
                                    title: o,
                                    quizInfo: s,
                                    usedTime: s.usedTime,
                                    status: a,
                                    visible: !1,
                                    curQuestionIndex: u
                                }, f = Object(h.a)(), s.questions.forEach((function (e, t) {
                                    e.chose && (f = f.set(t, Object(h.a)(e.chose)))
                                })), l.answers = f, this.setState(l, this.startTimer), this.debouncedSave = Object(v.debounce)(this.save, 5e3);
                            case 33:
                            case "end":
                                return e.stop()
                        }
                ...
                value: function () {
                    var e = this,
                        ...
                        g = t.scoreData,
                        k = t.loading,
                        S = r.get(a) || Object(h.a)(),
                        P = n.get(a),
                        z = [],
                        _ = r.size;
                    return v === Y ? z = null == n ? void 0 : n.map((function (e, t) {
                        var o = r.get(t),
                            a = {
                                type: "disabled"
                            };
                        if (t < _) 4 === e.questionDisplay && o.size < e.answers.length || 2 === e.questionDisplay && 0 === o.size ? a.type = "empty" : a.type = "filled";
                        else if (t === _ && (a.type = "empty", _ > 0)) {
                            var i = r.get(t - 1),
                                c = n.get(t - 1),
                                s = c.questionDisplay,
                                u = c.answers;
                            (4 === s && i.size < u.length || 2 === s && 0 === i.size) && (a.type = "disabled")
                        }
                        return a
                    })) : v === W && (z = this.isReadingSolutionNeverAnswered() ? new Array(l.questions.length).fill({
                        type: "empty"
                    }) : l.questions.map((function (e) {
                        return {
                            type: Object(c.l)(e) ? "correct" : "wrong"
                        }
                    }))), o.a.createElement(y.a, null, o.a.createElement(d.Helmet, null, o.a.createElement("title", null, "专项答题")), o.a.createElement("div", {
                        ...
                        onLeave: function (t, n) {
                            var r;
                            v !== Y || Object(c.n)() || (t.preventDefault(), Object(w.a)({
                                title: "确定要退出考试？",
                                onOk: function () {
                                    e.save()
                                },
                    ...
                    }), o.a.createElement(E.a, null), v === K ? o.a.createElement(o.a.Fragment, null, o.a.createElement("div", {
                        className: "header-row"
                    }, o.a.createElement("div", {
                        className: "title"
                    }, s)), o.a.createElement(m.a, {
                        spinning: k
                    }, o.a.createElement(j.a, D({
                        type: M.b.PAPER,
                        onClickSolutionButton: this.onClickSolutionButton
                    }, l, g)))) : o.a.createElement(o.a.Fragment, null, o.a.createElement(A, {
                        curQuestionIndex: a,
                        data: z,
                        onClick: function (t) {
                            e.setState({
                        ...
                        type: "clock-circle"
                    }), v === Y && o.a.createElement("span", null, o.a.createElement("span", {
                        className: "time"
                    }, " ", Object(c.f)(p.totalTime - i))), v === W && o.a.createElement("span", null, o.a.createElement("span", null, " 用时"), o.a.createElement("span", {
                        className: "time"
                    }, Object(c.f)(l.usedTime)))), P && o.a.createElement("div", {
                    ...
                    }, "< 上一题"), o.a.createElement(u.a, {
                        type: "primary",
                        className: "next-btn",
                        disabled: v !== W && 4 === P.questionDisplay && S.size < P.answers.length || v !== W && 2 === P.questionDisplay && 0 === S.size || a >= n.size - 1 || a >= _ && v === Y,
                        onClick: this.onClickNext
                    }, "下一题"), v !== W && this.areAllQuestionAnswered() && o.a.createElement(u.a, {
                        type: "primary",
                        ghost: !0,
                        className: "submit-btn",
                        onClick: this.onClickSubmit
                    }, "交卷")), v === W && o.a.createElement(x.a, {
                        question: P
                    })))))
                }
            }, {
                ...
                value: function () {
                    var e = this.state,
                        t = e.status,
                        n = e.practiceResult;
                    return t === W && !(null != n && n.questions[0].chose)
                }
            }]) && V(t.prototype, n), r && V(t, r), s
        }(o.a.Component);
            ...
            return t = c, (n = [{
                ...
                value: function () {
                    var e, t = this.props,
                        ...
                        x = t.onlyTotalTipScore,
                        E = d === j.b.PAPER,
                        k = d === j.b.PRACTICE,
                        S = d === j.b.WEEKLY,
                        P = !(E && a === f);
                    E ? e = "再来一次" : k ? e = "再来一组" : S && (e = "再练一次");
                    var z = "",
                        _ = "";
                    return x && u && "--" !== u && (_ = "您的得分计入总积分"), 103 === g ? (z = "领取奖励已达今日上限", Object(O.m)("exam-paper-detail") && w("专项答题积分已达今日上限", 2e3)) : 102 === g && (z = "已领取积分"), z = _ ? z ? s.a.createElement("div", {
                        style: {
                            textAlign: "center"
                        }
                    }, z, s.a.createElement("div", null, _)) : _ : z, s.a.createElement("div", {
        ...
        var J = function (e) {
            ...
            return t = c, (n = [{
                ...
                value: function () {
                    ...
                    if(daan.innerHTML != n.questionDesc)
                        daan.innerHTML = n.questionDesc;
                    return s.a.createElement("div", {
                ...
                value: function (e) {
                    ...
                    return t.map((function (e) {
                        ...
                        var t, n;
                        return e.target && a ? (n = "correct", t = q.a) : !a && e.choice && (n = "false", t = C.a), s.a.createElement("div", {
    ...
    tDyU: function (e, t, n) {
        ...
        Object(h.b)() && (o.a.defaults.headers.common.Pragma = "no-cache"), z.interceptors.request.use((function (e) {
            return P.setRequestHeaders(e.headers), l(e)
        }), f), z.interceptors.response.use((function (e) {
            var t = e.headers && e.headers["page-version-control"];
            return P.checkIsGray(t),
                function (e) {
        ...
        function T() {
            return (T = k(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/practice/pc/weekly/more", e.next = 3, z.get(_ + "/api/exam/service/practice/pc/weekly/more", {
                                params: t
                            });
                        case 3:
        ...
        function A() {
            return (A = k(regeneratorRuntime.mark((function e() {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/practice/statistic", e.next = 3, z.get(_ + "/api/exam/service/practice/statistic");
                        case 3:
                            return t = e.sent, e.abrupt("return", t.data.data);
                        case 5:
                        case "end":
        ...
        function M() {
            return (M = k(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/answer/record/pc/list", e.next = 3, z.get(_ + "/api/exam/service/answer/record/pc/list", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function B() {
            return (B = k(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/solution", e.next = 3, z.get(_ + "/api/exam/service/detail/solution", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function L() {
            return (L = k(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/queryV3", e.next = 3, z.get(_ + "/api/exam/service/detail/queryV3", {
                                params: O(O({}, t), {}, {
                                    forced: !0
                                }),
                                examNet: !0
        ...
        function F() {
            return (F = k(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/save", e.next = 3, z.post(_ + "/api/exam/service/detail/save", t);
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
                        case 5:
                        case "end":
        ...
        function X() {
            return (X = k(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/paper/pc/list", e.next = 3, z.get(_ + "/api/exam/service/paper/pc/list", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function Z() {
            return (Z = k(regeneratorRuntime.mark((function e() {
                var t;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/common/deduplicateRandomSearchV3", e.next = 3, z.get(_ + "/api/exam/service/common/deduplicateRandomSearchV3", {
                                params: {
                                    limit: 5,
        ...
        function Y() {
            return (Y = k(regeneratorRuntime.mark((function e(t, n) {
                var r, o, a;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function ee() {
            return (ee = k(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/score", e.next = 3, z.get(_ + "/api/exam/service/detail/score", {
                                params: {
                                    queryTipScoreId: t
                                }
                            });
