! function (e) {
        ...
        var ne = function (e) {
            ...
            function s() {
                ...
                return function (e, t) {
                    ...
                    if (e.save(), e.state.status === G && !Object(c.n)()) {
                        t.preventDefault();
                    ...
                    return regeneratorRuntime.wrap((function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                if (n = e.state, r = n.quizInfo, o = n.usedTime, n.status === G) {
                                    t.next = 3;
                                    break
                                }
                                return t.abrupt("return");
            ...
            return t = s, (n = [{
                ...
                value: (a = H(regeneratorRuntime.mark((function e() {
                    ...
                    return regeneratorRuntime.wrap((function (e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (t = Object(c.g)(), n = t.id, r = t.examScoreId, this.setupBeforeunloadListener(), (a = r ? W : G) !== W) {
                                    e.next = 7;
                                    break
                                }
                ...
                value: function () {
                    var e = this,
                        ...
                        z = [],
                        _ = r.size;
                    return v === G ? z = null == n ? void 0 : n.map((function (e, t) {
                        var o = r.get(t),
                            a = {
                                type: "disabled"
                            };
                        ...
                        onLeave: function (t, n) {
                            var r;
                            v !== G || Object(c.n)() || (t.preventDefault(), Object(w.a)({
                                title: "确定要退出考试？",
                                onOk: function () {
                                    e.save()
                                },
                    ...
                    }, l, g)))) : o.a.createElement(o.a.Fragment, null, o.a.createElement(T, {
                        curQuestionIndex: a,
                        data: z,
                        onClick: function (t) {
                            e.setState({
                        ...
                        type: "clock-circle"
                    }), v === G && o.a.createElement("span", null, o.a.createElement("span", {
                        className: "time"
                        ...
                        type: "primary",
                        className: "next-btn",
                        disabled: v !== W && 4 === P.questionDisplay && S.size < P.answers.length || v !== W && 2 === P.questionDisplay && 0 === S.size || a >= n.size - 1 || a >= _ && v === G,
            ...
            return t = c, (n = [{
                ...
                value: function (e) {
                    ...
                    return t.map((function (e) {
                        ...
                        var t, n;
                        return e.target && a ? (n = "correct", t = R.a) : !a && e.choice && (n = "false", t = C.a), s.a.createElement("div", {
    ...
    tDyU: function (e, t, n) {
        ...
        Object(h.b)() && (o.a.defaults.headers.common.Pragma = "no-cache"), x.interceptors.request.use(l, f), x.interceptors.response.use((function (e) {
        ...
        function P() {
            return (P = O(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/practice/pc/weekly/more", e.next = 3, x.get(E + "/api/exam/service/practice/pc/weekly/more", {
                                params: t
                            });
                        case 3:
        ...
        function _() {
            return (_ = O(regeneratorRuntime.mark((function e() {
                var t;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/practice/statistic", e.next = 3, x.get(E + "/api/exam/service/practice/statistic");
                        case 3:
                            return t = e.sent, e.abrupt("return", t.data.data);
                        case 5:
                        case "end":
        ...
        function q() {
            return (q = O(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/answer/record/pc/list", e.next = 3, x.get(E + "/api/exam/service/answer/record/pc/list", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function R() {
            return (R = O(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/solution", e.next = 3, x.get(E + "/api/exam/service/detail/solution", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function C() {
            return (C = O(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/queryV3", e.next = 3, x.get(E + "/api/exam/service/detail/queryV3", {
                                params: g(g({}, t), {}, {
                                    forced: !0
                                }),
                                examNet: !0
        ...
        function D() {
            return (D = O(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/save", e.next = 3, x.post(E + "/api/exam/service/detail/save", t);
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
                        case 5:
                        case "end":
        ...
        function H() {
            return (H = O(regeneratorRuntime.mark((function e(t) {
                var n;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/paper/pc/list", e.next = 3, x.get(E + "/api/exam/service/paper/pc/list", {
                                params: t
                            });
                        case 3:
                            return n = e.sent, e.abrupt("return", n.data.data);
        ...
        function U() {
            return (U = O(regeneratorRuntime.mark((function e() {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/common/deduplicateRandomSearchV3", e.next = 3, x.get(E + "/api/exam/service/common/deduplicateRandomSearchV3", {
                                params: {
                                    limit: 5,
        ...
        function Q() {
            return (Q = O(regeneratorRuntime.mark((function e(t, n) {
                var r, o, a;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function J() {
            return (J = O(regeneratorRuntime.mark((function e(t, n) {
                var r, o, a;
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
        ...
        function Y() {
            return (Y = O(regeneratorRuntime.mark((function e(t) {
                ...
                return regeneratorRuntime.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return "/api/exam/service/detail/score", e.next = 3, x.get(E + "/api/exam/service/detail/score", {
                                params: {
                                    queryTipScoreId: t
                                }
                            });
